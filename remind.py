...
if __name__ == "__main__":
    ...
    dialog = read_dialog("./dialog/dialog_solar_jiu/dialog_history_5.txt")
...
루나의 한마디:'''
    ...
    remind = make_remind(bot_summary_template, comment_template, dialog_summary, user_name="수정", stop_words=stop_words)
    print("summary\n", dialog_summary)
    print("remind\n",remind)